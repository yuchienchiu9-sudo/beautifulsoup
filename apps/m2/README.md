...
1) Open a terminal and navigate to the **beautifulsoup/apps/m2** directory:
   cd "Milestone-2\beautifulsoup\apps\m2"
    python task2.py "United States - Wikipedia.html" "https://en.wikipedia.org" > links.txt 
...
Task 3 — Extract all headings (h1–h6)
    ...
    python task3.py ".\United States - Wikipedia.html" > headings.txt 

    or (for your own test file): python task3.py <input.html or input.xml> > headings.txt (put the new test html or XMLname to replace input.html or input.xml)
...
Task 6 — SoupReplacer
    ...
    2.python task6.py "United States - Wikipedia.html" 
    or (for your own test file): python task6.py <input.html> (put the new test html or XMLname to replace input.html or input.xml)
